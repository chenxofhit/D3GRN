...
dataname = 'DREAM5 Network 3';
texname=  'DREAM5_Network_3_AUPR';
...
%legend('BS=100','BS=200','BS=300','BS=400','BS=500','Location','southeast')
legend('BS=100','BS=200','Location','southeast')
title(dataname);
...
dataname = 'DREAM5 Network 3';
texname=  'DREAM5_Network_3_AUROC';
