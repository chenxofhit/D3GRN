...
dataname = 'Network1';
bootstrapmat = '/Users/chenx/Documents/Exp/bLARS-Exp/ARNI/data_dream5/Network1_result/idxcol_bio216-workstation_bs500_all_20180216065504.mat';
...
score_mat = repmat(0, 5,25);
auroc_mat = repmat(0,5,25);
aupr_mat = repmat(0,5,25);
